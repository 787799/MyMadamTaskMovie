      ...
      <section class="mb-32">
        <div class="flex justify-center">
          <div class="max-w-[700px] text-center">
            <p class="mb-6 font-bold uppercase text-white text-4xl dark:text-primary-400">
              Features
            </p>
            <h2 class="mb-6 text-white text-6xl font-bold">Why is it so great?</h2>
            <p class="mb-16 text-white dark:text-neutral-300">
        ...
        <div class="grid gap-x-6 md:grid-cols-2 lg:grid-cols-4 xl:gap-x-12">
          <div class="mb-12 ">
            <div class="flex">
              ...
              <div class="ml-2 grow">
                <p class="mb-1 text-white font-bold">Support 24/7</p>
                <p class="text-white dark:text-neutral-300">
          ...
          <div class="mb-12">
            <div class="flex">
              ...
              <div class="ml-2 grow">
                <p class="mb-1 text-white font-bold">Tracking</p>
                <p class="text-white dark:text-neutral-300">
          ...
          <div class="mb-12">
            <div class="flex">
              ...
              <div class="ml-2 grow">
                <p class="mb-1 text-white font-bold">Reporting</p>
                <p class="text-white dark:text-neutral-300">
          ...
          <div class="mb-12">
            <div class="flex">
              ...
              <div class="ml-2 grow">
                <p class="mb-1 text-white font-bold">Analytics</p>
                <p class="text-white dark:text-neutral-300">
          ...
          <div class="mb-12">
            <div class="flex">
              ...
              <div class="ml-2 grow">
                <p class="mb-1 text-white font-bold">Huge community</p>
                <p class="text-white dark:text-neutral-300">
          ...
          <div class="mb-12">
            <div class="flex">
              ...
              <div class="ml-2 grow">
                <p class="mb-1 text-white font-bold">Easy to use</p>
                <p class="text-white dark:text-neutral-300">
          ...
          <div class="mb-12">
            <div class="flex">
              ...
              <div class="ml-2 grow">
                <p class="mb-1 text-white font-bold">Frequent updates</p>
                <p class="text-white dark:text-neutral-300">
          ...
          <div class="mb-12">
            <div class="flex">
              ...
              <div class="ml-2 grow">
                <p class="mb-1 text-white font-bold">Responsive</p>
                <p class="text-white dark:text-neutral-300">
