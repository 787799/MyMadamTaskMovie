...
import { addFavratMovie } from "../GlobaRedux/store";
...
export default function ShowMovie({ movie }) {
  ...
  function addtoWatchList(id) {
    console.log("hitted on component");
  ...
  return (
    <>
      <div className="bg-gray-900  flex  items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl w-full px-6 flex flex-col lg:flex-row justify-between ">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center gap-2">
            <h2 className="text-5xl font-extrabold tracking-tight text-gray-100 text-start">
              {movie.title}
            </h2>
            <p className="text-lg text-gray-100 ">{movie.tagline}</p>
            <div className="flex flex-wrap justify-start ">
              {movie &&
                movie?.genres?.map((genre) => (
                  <span
                    key={genre.id}
                    className="inline-block bg-gray-500 rounded-full px-3 py-1 text-sm font-semibold text-gray-100 m-1"
                  >
                    {genre.name}
                  </span>
                ))}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-lg text-gray-100">{movie.release_date}</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-gray-100">
                  Runtime:
                </h3>
                <p className="text-lg text-gray-200">{movie.runtime} minutes</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-gray-100">
                  Average Vote:
                </h3>
                <p className="text-lg text-gray-200">{movie.vote_average}</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-gray-100">
                  Vote Count:
                </h3>
                <p className="text-lg text-gray-200">{movie.vote_count}</p>
              </div>
            </div>
            <div className=" bg-gray-500 w-full text-center px-5 py-2 flex justify-center my-4 items-center rounded-full  ">
              <a
                href={movie.homepage}
                target="_blank"
                rel="noopener noreferrer"
                className="text-lg text-center font-semibold text-white hover:text-blue-800"
              >
                Play
              </a>
            </div>
      ...
      <div className="mt-0 bg-black py-10 px-4 md:px-8">
